...
class CarAgent(BaseAgent):
    ...
    def create_complete_car(self, requirements: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.enable_logging:
            ...
            logger.debug(f"Current context items: {len(self.memory.get_all_context())}")
            logger.debug(f"Current message history: {len(self.memory.get_messages())}")
    ...
    def _add_car_metadata(self, car_data: Dict[str, Any], requirements: Dict[str, Any]) -> Dict[str, Any]:
        ...
        car_data["metadata"] = {
            ...
            "interaction_count": len(self.memory.get_messages())
        }
